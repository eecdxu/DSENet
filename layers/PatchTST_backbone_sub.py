...
class TSTiEncoder(nn.Module):  #i means channel-independent
    def __init__(self, c_in, patch_num, patch_len, max_seq_len=1024,
        ...
        self.encoder2 = TSTEncoder2(pe, learn_pe, patch_num, q_len, self.num_words, inner_dim, d_model, n_heads, d_k=d_k, d_v=d_v, d_ff=d_ff, norm=norm, attn_dropout=attn_dropout, dropout=dropout,embedding_dropout=embedding_dropout,
                                   pre_norm=pre_norm, activation=act, res_attention=res_attention, n_layers=n_layers, store_attn=store_attn,
                                   )
        self.encoder3 = TSTEncoder3(pe, learn_pe, patch_num, q_len, self.num_words, inner_dim, d_model, n_heads, d_k=d_k, d_v=d_v, d_ff=d_ff, norm=norm, attn_dropout=attn_dropout, dropout=dropout,embedding_dropout=embedding_dropout,
                                   pre_norm=pre_norm, activation=act, res_attention=res_attention, n_layers=n_layers, store_attn=store_attn,
                                   )
...
class TSTEncoderLayer(nn.Module):
    def __init__(self, pe, learn_pe, patch_num, q_len, num_words, inner_dim, d_model, n_heads, d_k=None, d_v=None, d_ff=256, store_attn=False,norm='BatchNorm', attn_dropout=0, dropout=0.,embedding_dropout=0.1,
        ...
        self.self_attn2 = _MultiheadAttention(d_model, n_heads, d_k, d_v, attn_dropout=attn_dropout, proj_dropout=dropout, res_attention=res_attention)
